...
def SummariseText(inp,no_of_sentences,key_words_inp):
  ...
  return   generated_text12_bertmodel,generated_text13_transformer_pipeline,generated_text14_t5_base
...
iface = gr.Interface(
  ...
  outputs=[ 
           ...
           gr.outputs.Textbox(label="* Summary-14 (Transformer t5-base)") ],title= "Auto summarization and Summary comparision(beta)"  )
